                  ...
                  itemBuilder: (ctx, index) => Slidable(
                    ...
                    child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Checkbox(value: toDoController.todo_list[index].isDone,
                               onChanged: (newValue){
                                toDoController.updateToDostatus(toDoController.todo_list[index].id);
                               },
                               ),
                               SizedBox(
                                width: 20,
                               ...
                               Text(
                                ...
                                style: TextStyle(
                                  decoration: 
                                  !toDoController.todo_list[index].isDone ? null:TextDecoration.lineThrough
                                ),
                               )
